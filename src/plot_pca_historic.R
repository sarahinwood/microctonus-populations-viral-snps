...
sample_info <- sample_table[,c(1,6,8,9,10)]
...
# read in data
pca <- fread("output/03_plink/ld_pruned_historic_final/filtered_snps_plink_pca.eigenvec", header = FALSE)
eigenval <- scan("output/03_plink/ld_pruned_historic_final/filtered_snps_plink_pca.eigenval")
