...
# read in data
pca <- fread("output/03_plink/ld_pruned_contemporary_final/filtered_snps_plink_pca.eigenvec", header = FALSE)
eigenval <- scan("output/03_plink/ld_pruned_contemporary_final/filtered_snps_plink_pca.eigenval")
